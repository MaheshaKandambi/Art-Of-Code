                    ...
                    <div class="row">
                         ...
                         <div class="col-lg-8 col-md-10 mx-auto col-12">
                              <div class="hero-text mt-5 text-center">
                                    ...
                                    <h6 data-aos="fade-up" data-aos-delay="300">Enjoy Your Code!</h6>

                                    <h1 class="text-white" data-aos="fade-up" data-aos-delay="500">Upgrade  your  coding  skill  at  Art  Of  Code</h1>

                                    <a href="#feature" class="btn custom-btn mt-3" data-aos="fade-up" data-aos-delay="600">Get started</a>

                                    <a href="#about" class="btn2 custom-btn bordered mt-3" data-aos="fade-up" data-aos-delay="600">learn more</a>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="d-flex flex-column justify-content-center ml-lg-auto mr-lg-5 col-lg-5 col-md-6 col-12">
                        <h2 class="mb-3 text-white" data-aos="fade-up">New to the class?</h2>

                        <h6 class="mb-4 text-white" data-aos="fade-up">Your membership is up to 2 months FREE ($62.50 per month)</h6>

                        <p data-aos="fade-up" data-aos-delay="200">Join with us to improve your HTML, CSS, JavaScript and learn the art of coding<br> To start this Career Path, sign up for ArtOfCode</p>
                        <br>

                        <!-- link to registrationFormCopy -->
                        <!-- <a href="registrationForm/html/login.html">
                        <input type="button" id="signup" value="Become a genius today"> 
                       
                        </a> -->

                        <div class="pp">
                            <a href="#" class="button" id="signup">Become a genius today</a>
                        </div>
                </div>
               ...
               <div class="container">
                    <div class="row">
                            ...
                            <div class="mt-lg-5 mb-lg-0 mb-4 col-lg-5 col-md-10 mx-auto col-12">
                                <h2 class="mb-4" data-aos="fade-up" data-aos-delay="300">Hello, we are Art OF Code</h2>

                                <p data-aos="fade-up" data-aos-delay="400">Art of code is an online academy for those who are interested in getting involved in the IT  field and want to learn about it. Here coding is teach simply by html, css, js, java, python, php, c, c# .This is attended by experienced teaching academy staff.
</p>

                                <p data-aos="fade-up" data-aos-delay="500">If you have any question regarding about <a rel="nofollow" href="https://www.tooplate.com/view/2119-gymso-fitness" target="_parent">Art OF Code Academy</a>, you can <a rel="nofollow" href="https://www.tooplate.com/contact" target="_parent">contact Tooplate</a> immediately. Thank you.</p>

                            </div>

                            <div class="ml-lg-auto col-lg-3 col-md-6 col-12" data-aos="fade-up" data-aos-delay="700">
                                <div class="team-thumb">
                                    <img src="images/team/a.png" class="img-fluid" alt="Trainer">
                            ...
                            <div class="mr-lg-auto mt-5 mt-lg-0 mt-md-0 col-lg-3 col-md-6 col-12" data-aos="fade-up" data-aos-delay="800">
                                <div class="team-thumb">
                                    <img src="images/team/c.jpg" class="img-fluid" alt="Trainer">
    ...
    <div class="login-wrap">
        ...
        <div class="login-html">
            ...
            <div class="login-form">  
                ...
                <form name="RegForm" action="registration.php" onsubmit="return validation()" method="post">
