            ...
            <div class="login-form">  
                ...
                <div class="sign-in-htm">
                    ...
                    <div class="group">
                        ...
                        <input id="pass" type="password" class="input"  data-type="password" placeholder= " &#xf084  password" name="password" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" title="Must contain at least one number and one uppercase and lowercase letter, and at least 8 or more characters" required>
                    </div>
